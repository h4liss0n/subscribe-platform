...
var PurchaseService = /** @class */ (function () {
    ...
    PurchaseService.prototype.add = function (product) {
        ...
        var basicTax = (0,_utils_UtilsMath__WEBPACK_IMPORTED_MODULE_0__.roundUp)((subTotal * tax.basic) / 100);
        var importTax = (0,_utils_UtilsMath__WEBPACK_IMPORTED_MODULE_0__.roundUp)((0,_utils_UtilsMath__WEBPACK_IMPORTED_MODULE_0__.roundUp)((product.price * tax.import) / 100) * product.quantity);
        var salesTaxes = (0,_utils_UtilsMath__WEBPACK_IMPORTED_MODULE_0__.roundUp)(importTax + basicTax);
    ...
    PurchaseService.prototype.getSalesTaxes = function () {
        return (0,_utils_UtilsMath__WEBPACK_IMPORTED_MODULE_0__.roundUp)(this.items.reduce(function (acc, c) {
            acc += c.salesTaxes;
            return acc;
        }, 0));
    };
